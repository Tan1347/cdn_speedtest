...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupWebView() {
        ...
        webView.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean {
                ...
                Log.i("CDNTest", ">>> shouldOverrideUrlLoading: $url (isDownload=${isDownloadUrl(url)})")
                // 拦截文件下载链接
        ...
        webView.setDownloadListener { url, userAgent, contentDisposition, mimeType, contentLength ->
            Log.i("CDNTest", "setDownloadListener: $url, mimeType=$mimeType, disposition=$contentDisposition")
    ...
    private fun showDownloadConfirm(url: String, mimeType: String) {
        ...
        Log.i("CDNTest", "showDownloadConfirm: url=$url, fileName=$fileName, mimeType=$mimeType")
        ...
        lifecycleScope.launch {
            try {
                ...
                Log.i("CDNTest", "existingRecord=${existingRecord?.url}")
    ...
    private fun showFileConflictDialog(fileName: String, newUrl: String, mimeType: String, existingUrl: String) {
        Log.i("CDNTest", "showFileConflictDialog: fileName=$fileName, newUrl=$newUrl, existingUrl=$existingUrl")
    ...
    private fun startDownload(url: String, fileName: String, mimeType: String) {
        Log.i("CDNTest", "startDownload: url=$url, fileName=$fileName")
        val destPath = DownloadHelper.getDownloadDir(this).absolutePath
